    ...
    <footer className="bg-orange-500 text-white">
      <div className="mx-auto max-w-7xl px-4 py-14 md:px-6">
        <div className="grid gap-10 md:grid-cols-4">
          <div>
            <img src="/frienemies-logo.svg" alt="Frienemies" className="h-10 w-auto rounded-md bg-white p-1" />
          ...
          <div>
            ...
            <div className="flex rounded-full bg-white p-1">
              ...
              <button className="rounded-full bg-orange-500 px-4 py-2 text-sm font-semibold text-white">Join</button>
            </div>
          </div>
        </div>
